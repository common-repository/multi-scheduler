...
class Msbdt_Admin {
  ...
  public function msbdt_dependence_loader(){
    ...
    require_once plugin_dir_path( __FILE__ ) . 'query/msbdt-location-query.php';
	...
	public function msbdt_define_page(){
		...
		$parents = array(
			           ...
			           'page_title'  => 'appointment',              //$parent_slug
						     'menu_title'  => 'Multi-Scheduler',          //$page_title
	...
	public function msbdt_define_subpage(){
		...
		$parents = array(
			           ...
			           'parent_slug' => 'msbdt_appointment',    //$parent_slug
						     ...
						     'menu_title'  => 'Location',       //$menu_title
						     'capability'  => 'manage_options', //$capability
						     'menu_slug'   => 'msbdt_location', 
			            ),
    ...
    public function msbdt_page_creater(){
     ...
     public function  msbdt_appointment_callback(){
           ...
           $approve_appointment = (current_user_can('manage_options') && is_admin() ) ?
	                               msbdt_appointment_callback_form():
	                               wp_die();
     }  
     ...
     public function  msbdt_schedule_callback(){
         require_once plugin_dir_path( __FILE__ ) . '/templates/msbdt-time-slote.php';       
           $set_timeslote_per_single_professional = (current_user_can('manage_options') && is_admin() ) ?
	                      msbdt_appointment_add_time_slote_form():
	                      wp_die();		        
     } 
     public function  msbdt_professional_callback(){
          require_once plugin_dir_path( __FILE__ ) . '/templates/msbdt-professional.php';
          $add_professional = (current_user_can('manage_options') && is_admin() ) ?
                            msbdt_appointment_add_profession_form():
                            wp_die();
     } 
     public function  msbdt_location_callback(){
           require_once plugin_dir_path( __FILE__ ) . '/templates/msbdt-location.php';
           $add_location = (current_user_can('manage_options') && is_admin())?
                           msbdt_appointment_add_location_form(): 
                           wp_die();     
     }
     ...
     public function  msbdt_setting_callback(){
      ...
      public function msbdt_setting_api(){
        ...
        /* register_setting( $option_group, $option_name, $sanitize_callback );  */  
          register_setting('mas-frontend-language-setting','frontend_name',
                           array($this,'msbdt_frontend_name_sanitize'));
          register_setting('mas-frontend-language-setting','frontend_email',
                           array($this,'msbdt_frontend_email_sanitize'));
          register_setting('mas-frontend-language-setting','frontend_contact',
                            array($this,'msbdt_frontend_contact_sanitize'));
          register_setting('mas-frontend-language-setting','frontend_location',
                            array($this,'msbdt_frontend_location_sanitize'));
          register_setting('mas-frontend-language-setting','frontend_professional',
                            array($this,'msbdt_frontend_professional_sanitize'));
          register_setting('mas-frontend-language-setting','frontend_message',
                            array($this,'msbdt_frontend_message_sanitize'));
          register_setting('mas-frontend-language-setting','frontend_error_message',
                            array($this,'msbdt_frontend_required_message_sanitize'));         
          register_setting('mas-frontend-language-setting','frontend_button',
          ...
          add_settings_field('frontend_name' ,                                       // $id
           ...
           add_settings_field('frontend_location' , 
                               __( 'Location', 'multi-scheduler' ), 
                               array($this,'msbdt_frontend_langues_setting_cb_for_location'),
                              'mas_language_setting',
                              'mas_language_setting',
           ...
           add_settings_field('frontend_error_message' , 
                               __( 'Error Message', 'multi-scheduler' ), 
                               array($this,'msbdt_frontend_langues_setting_cb_for_error_message'),
                              'mas_language_setting',
                              'mas_language_setting',
                               array( 'id' => 'frontend_error_message', 
                                     'class'=>'form-group',
                                     'type' => 'text' , 
                                     'name'=>'frontend_error_message' ));
 ...
 ///////////////////////////////////////////////////////////////////////////////////////*/   
           ...
           register_setting('mas-calender-setting','calender_border_color');
           ...
           add_settings_field('calender_day_text_color' , 
                              __( 'Day Tex Color', 'multi-scheduler' ),
           ...
           add_settings_field('calender_day_digit_color' , 
                              __( 'Day Digital Color', 'multi-scheduler' ),
           ...
           add_settings_field('calender_border_color' , 
                             __( 'Border Color', 'multi-scheduler' ),
                              array($this,'msbdt_calender_border_color_cb'),
                              'mas_calender_setting',
                              'mas_calender_setting',
                              array( 'id' => 'text_color', 
                                     'class'=>'form-group',
                                     'type' => 'text' , 
                                     'name'=>'calender_border_color' ));
 ...
 ///////////////////////////////////////////////////////////////////////////////////////*/
    ...
    public function msbdt_frontend_langues_setting_cb_for_location($args){
    ...
    public function msbdt_frontend_langues_setting_cb_for_error_message($args){
   ...
   public function msbdt_calender_border_color_cb($args){
