...
////////////////////////////////////////////////////////////////////////////////////////////*/
        ...
        ( get_option( 'frontend_name' ) == false )? 
                  update_option( 'frontend_name', 'Name' , null ,  'no' ) : '' ;
         ( get_option( 'frontend_email' ) == false )? 
                  update_option( 'frontend_email', 'Email', null ,  'no' ) : '' ;
         ( get_option( 'frontend_contact' ) == false )? 
                  update_option( 'frontend_contact', 'Contact No ' , null ,  'no' ) : '' ;
         ( get_option( 'frontend_location' ) == false )? 
                  update_option( 'frontend_location', 'Location' , null ,  'no' ) : '' ;
         ( get_option( 'frontend_professional' ) == false )? 
                  update_option( 'frontend_professional', 'Doctor' , null ,  'no' ) : '' ;
         ( get_option( 'frontend_message' ) == false )? 
                  update_option( 'frontend_message', 'Message' , null ,  'no' ) : '' ;
         ( get_option( 'frontend_error_message' ) == false )? 
                  update_option( 'frontend_error_message', 'Required' , null ,  'no' ) : '' ;
