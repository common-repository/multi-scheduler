(function($){
    ...
    $(document).ready(function(){  
        ...
        professional_id = $('#mas_public_professional_id').val();

        if(professional_id){ 
          ajaxRequest_byId(ajaxurl, professional_id); 
        }     

        $('#mas_public_professional_id').on('change', function(e){

              professional_change_id = $(this).val();
              ajaxRequest_byId(ajaxurl, professional_change_id); 

        }); /*==============  end change event of #mas_public_professional_id ============*/      
